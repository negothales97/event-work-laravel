...
class InternalError
{
     ...
     * @const string
     */
    const BASE_URL_MORE_INFO = 'https://docs.google.com/spreadsheets/d/1WZp1jo1embxmfrSof2YQkXuPmWqzsPKpkk6TF6o4XYc/edit?usp=sharing';
    ...
    public function __construct(
        ...
        if (is_null($moreInfo) && !is_null($code)) {
            $this->moreInfo = self::BASE_URL_MORE_INFO;
        }
    }
